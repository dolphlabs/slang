...
- [ ] 1. GC pause attribution (histogram + per-request alloc counters, behind a flag)
- [ ] 2. Zero-alloc serve path (intern response literal, bulk wire fill or send-from-literal)
